      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.stylus')) has-danger @endif">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.cartridge')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.first_sound')) has-danger @endif">
          <div class="col-sm-4 detail-label">
