...
class ItemsController extends Controller implements HasMiddleware
{
    ...
    public function store(ItemRequest $request)
    {
        ...
        if ($batch) {
            $request->session()->put('alert', ['type' => 'success', 'message' => '<strong>Yesss!</strong> '.
    ...
    public function update($id, ItemRequest $request)
    {
        ...
        $request->session()->put('alert', ['type' => 'success', 'message' => '<strong>Hooray!</strong> '.
    ...
    public function batchUpdate(ItemRequest $request)
    {
        ...
        $request->session()->put('alert', ['type' => 'success', 'message' => '<strong>That was handy!</strong> '.
