...
<div id="detail">
  ...
  <div class="row last">
    <div class="col-xs-12 actions">
      <a class="btn btn-sm btn-secondary" role="button" href="{{ route('cuts.edit', array($instance->id, $cut->id)) }}"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
      ...
      {!! Form::open(array('route' => array('cuts.destroy', $instance->id, $cut->id), 'method' => 'delete', 'style' => 'display: inline;')) !!}
