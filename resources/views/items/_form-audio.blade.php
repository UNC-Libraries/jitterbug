      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.size')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.track_configuration')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.audio_base')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.audio_content_description')) has-danger @endif">
          <div class="col-sm-4 detail-label">
