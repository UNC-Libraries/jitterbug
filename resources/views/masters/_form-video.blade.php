      ...
      <div class="row">
        <div class="form-group @if ($errors->has('masterable.videoFrameSize')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('masterable[videoFrameSize]', routeName() === 'masters.create' ? '720 x 480' : null, array('class' => 'form-control form-control-sm')) !!}
      ...
      <div class="row">
        <div class="form-group @if ($errors->has('masterable.videoAspectRatio')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('masterable[videoAspectRatio]', routeName() === 'masters.create' ? '4:3' : null, array('class' => 'form-control form-control-sm')) !!}
