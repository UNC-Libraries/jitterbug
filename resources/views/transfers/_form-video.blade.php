      ...
      <div class="row">
        <div class="form-group @if ($errors->has('subclass.time_base_corrector')) has-danger @endif">
          <div class="col-xs-4 detail-label">
            {!! Form::label('subclass[time_base_corrector]', 'Time Base Corrector', array('class' => 'form-control-label')) !!}
          </div>
          <div class="col-xs-7 detail-value">
            {!! Form::text('subclass[time_base_corrector]', null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. BuiltIn')) !!}
      ...
      <div class="row">
        <div class="form-group @if ($errors->has('subclass.ad_converter')) has-danger @endif">
          <div class="col-xs-4 detail-label">
            {!! Form::label('subclass[ad_converter]', 'A/D Converter', array('class' => 'form-control-label')) !!}
          </div>
          <div class="col-xs-7 detail-value">
            {!! Form::text('subclass[ad_converter]', null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. BuiltIn')) !!}
