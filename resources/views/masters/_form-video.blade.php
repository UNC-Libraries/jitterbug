      {{-- VideoMaster fields --}}
      <div class="row">
        {{-- video_file_format and video_file_codec now reside in preservation_masters in the file_format and file_codec fields --}}
        <div class="form-group @if ($errors->has('video_file_format')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('video_file_format', routeName() === 'masters.create' ? 'MKV' : null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. MKV')) !!}
      ...
      <div class="row">
        <div class="form-group @if ($errors->has('video_file_codec')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('video_file_codec', routeName() === 'masters.create' ? 'FFV1' : null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. FFV1')) !!}
      ...
      <div class="row">
        <div class="form-group @if ($errors->has('subclass.video_frame_size')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('subclass[video_frame_size]', routeName() === 'masters.create' ? '720 x 486' : null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. 720 x 486')) !!}
      ...
      <div class="row">
        <div class="form-group @if ($errors->has('subclass.video_aspect_ratio')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('subclass[video_aspect_ratio]', routeName() === 'masters.create' ? '4:3' : null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. 4:3')) !!}
