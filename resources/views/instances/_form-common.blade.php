      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('file_name')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('file_location')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('file_size_in_bytes')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('duration')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('checksum')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('access_file_location')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('reproduction_machine_id')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('project_id')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('department_id')) has-danger @endif">
          <div class="col-sm-4 col-sm-offset-1 detail-label">
