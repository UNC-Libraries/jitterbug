      ...
      <div class="row">
        ...
        <div class="mb-3 @if ($errors->has('film_file_format')) has-danger @endif">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('film_file_codec')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.film_frame_size')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.film_aspect_ratio')) has-danger @endif">
          <div class="col-sm-4 detail-label">
