      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('transfer_id')) has-danger @endif">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('performer_composer')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('pm_start_time')) has-danger @endif">
          <div class="col-sm-4 detail-label">
