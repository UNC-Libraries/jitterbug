      ...
      <div class="row">
        ...
        <div class="mb-3 @if ($errors->has('audio_file_format')) has-danger @endif">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('audio_file_codec')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.sampling_rate_id')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.tape_brand_id')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.pm_speed_id')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.test_tones')) has-danger @endif">
          <div class="col-sm-4 detail-label">
