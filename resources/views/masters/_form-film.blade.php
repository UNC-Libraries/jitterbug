      ...
      <div class="row">
        ...
        <div class="form-group @if ($errors->has('film_file_format')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('film_file_format', routeName() === 'instances.create' ? 'DPX' : null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. DPX')) !!}
      ...
      <div class="row">
        <div class="form-group @if ($errors->has('film_file_codec')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('film_file_codec', routeName() === 'instances.create' ? 'Uncompressed 10-bit' : null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. Uncompressed 10-bit')) !!}
      ...
      <div class="row">
        <div class="form-group @if ($errors->has('subclass.film_frame_size')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('subclass[film_frame_size]', routeName() === 'instances.create' ? '720 x 486' : null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. 720 x 486')) !!}
      ...
      <div class="row">
        <div class="form-group @if ($errors->has('subclass.film_aspect_ratio')) has-danger @endif">
          ...
          <div class="col-xs-7 detail-value">
            {!! Form::text('subclass[film_aspect_ratio]', routeName() === 'instances.create' ? '4:3' : null, array('class' => 'form-control form-control-sm', 'placeholder' => 'e.g. 4:3')) !!}
