...
#
## Install the Data Import Handler package
...
#cd sudo wget --no-verbose -nc https://github.com/SearchScale/dataimporthandler/releases/download/v9.3.0/data-import-handler-9.3.0.jar
