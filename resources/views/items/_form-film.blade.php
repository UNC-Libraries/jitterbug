      {{-- FilmItem fields --}}
       <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.film_element')) has-danger @endif">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.film_base')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.film_color')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.length_in_feet')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.film_stock')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.edge_code')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.shrinkage_percent')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.can_number')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.condition')) has-danger @endif">
          <div class="col-sm-4 detail-label">
      ...
      <div class="row">
        <div class="mb-3 @if ($errors->has('subclass.film_content_description')) has-danger @endif">
          <div class="col-sm-4 detail-label">
